...
class SquatAnalyzer:
    def __init__(self, args):
        ...
        try:
            ...
            print(f"Warning: Text-to-speech initialization failed ({e}). Audio feedback disabled.")
            self.engine = None
        self.args = args
        ...
        self.cap = self._setup_input(args.input, args.video_path)
    ...
    def _load_config(self):
        ...
        if os.path.exists(config_path):
            ...
            print("config.json not found, creating with default config.")
    ...
    def _setup_input(self, input_source, video_path):
        if input_source == 'video':
            ...
            return cv2.VideoCapture('squats_video.mp4')
        return cv2.VideoCapture('squats_video.mp4')
    ...
    def give_feedback(self, score, knee_toe_left, knee_toe_right, depth_valid, phase):
        ...
        try:
            ...
            print(f"Warning: Failed to provide audio feedback ({e}).")
    ...
    def save_progress(self, date):
        ...
        data[date] = {
            ...
            "_good_frame_ratio": (self.good_frames / self.frame_count * 100) if self.frame_count > 0 else 0,
